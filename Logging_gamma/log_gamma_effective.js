...
let maxact = parseInt(argv.m)
let lambdaact = parseInt(argv.a)
let vol = parseInt(argv.v)
...
let conf1 = {
	...
	V : [0,vol],					// Target volume of each cellkind
...
/*	---------------------------------- */
let C1, gm1, C2, gm2, C3, gm3, C4, gm4, C5, gm5
...
while(C2.time < 50000){
	step()
	if(C2.time % 5 == 0){
		console.log(C1.time + "\t" + (C1.getConstraint("PerimeterConstraint").cellperimeters[1]/C1.getConstraint("PerimeterConstraint2").cellperimeters[1]))
