...
let xieffmeasured = parseFloat(argv.x)
...
class CPM2 extends CPM.CPM{
	deltaH ( sourcei, targeti, src_type, tgt_type ){
		...
		if(src_type == 1 && this.docopy(r) && this.time > 499){
			console.log(this.time + "\t" + this.conf.P[1])
		}
		return r
	}
}
