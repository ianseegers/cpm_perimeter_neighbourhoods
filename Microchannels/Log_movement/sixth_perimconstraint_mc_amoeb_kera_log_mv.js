...
function step(){
	C2.timeStep()
	if(C2.time % 5 == 0){
		console.log(C2.time + "\t" + "sixth" + "\t" +
		C2.getStat(CPM.CentroidsWithTorusCorrection)[1][0] + "\t" +
		C2.getStat(CPM.CentroidsWithTorusCorrection)[1][1] + "\t" +
		C2.getStat(CPM.Connectedness)[1])
	}
}
